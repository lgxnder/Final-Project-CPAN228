...
public class UserService {
    ...
    //Assign userrepository for database and passwordencoder for password encoding


    //Creating a contructor for userservice with userepository and passwordencoder
